...
## Testing
Tests can be run using `npm run test`, which launches a Chrome browser to run the tests in. Headless testing is possible using 'Headless Chrome', if you're interested in that, please follow instructions from https://developers.google.com/web/updates/2017/04/headless-chrome#cli.
