...
const otherTypesArrayWithTranslations = [
    ...
    [
        ...
        'IRIS (Biosensor), interferometrische reflectie-beeldsensor',
    ],
    ...
    [
        ...
        'SSIES, speciale sensoren-ionen, elektronen en scintillatie thermisch plasma-analysepakket',
    ],
    ...
    [
        ...
        'TriDAR, Triangulatie en LIDAR Geautomatiseerde Rendez-vous en Docking',
    ],
...
export function getSensorTypesTranslation(locale = 'en') {
...
function fromArrayToSensorTypesObject(ar: string[][], languageColumn = 0): Record<string, any> {
    const obj = {
        key: ar[0][0],
