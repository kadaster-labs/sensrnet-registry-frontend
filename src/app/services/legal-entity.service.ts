...
export class LegalEntityService {
    ...
    constructor(private env: EnvService, private http: HttpClient, private connectionService: ConnectionService) {}
    ...
    public async subscribe() {
        ...
        return {
            onRegister: this.legalEntityRegistered$,
            onUpdate: this.legalEntityUpdated$,
            onRemove: this.legalEntityRemoved$,
        };
    }
